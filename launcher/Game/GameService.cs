...
namespace launcher.Game
{
    ...
    public static class GameService
    {
        ...
        {
            var eaAppStatus = Managers.App.IsEAAppRunning();
            ...
            var mode = (eMode)(int)Ini.Get(Ini.Vars.Mode);
        ...
        private static void SetProcessorAffinity(Process gameProcess)
        {
            try
            {
                if (!int.TryParse((string)Ini.Get(Ini.Vars.Processor_Affinity), out int coreCount))
                {
