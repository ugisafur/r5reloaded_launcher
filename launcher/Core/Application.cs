...
namespace launcher.Core
{
    public static partial class Application
    {
        ...
        public static async Task SetupApp(MainWindow mainWindow)
        {
            ...
            if ((bool)IniSettings.Get(IniSettings.Vars.Enable_Discord_Rich_Presence))
            {
        ...
        {
            if (!(bool)IniSettings.Get(IniSettings.Vars.Auto_Launch_EA_App))
                return;
        ...
        {
            string libraryPath = (string)IniSettings.Get(IniSettings.Vars.Library_Location);
        ...
        {
            if (!(bool)IniSettings.Get(IniSettings.Vars.Enable_Notifications))
                return;
        ...
        public static Task ShowEULA() =>
            AnimateElement(EULA_Control, POPUP_BG, true, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task HideEULA() =>
            AnimateElement(EULA_Control, POPUP_BG, false, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        // Methods to show and hide DownloadOptFiles
        public static Task ShowDownloadOptlFiles() =>
            AnimateElement(OptFiles_Control, POPUP_BG, true, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task HideDownloadOptlFiles() =>
            AnimateElement(OptFiles_Control, POPUP_BG, false, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        // Methods to show and hide CheckExistingFiles
        public static Task ShowCheckExistingFiles() =>
            AnimateElement(CheckFiles_Control, POPUP_BG, true, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task HideCheckExistingFiles() =>
            AnimateElement(CheckFiles_Control, POPUP_BG, false, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task ShowAskToQuit() =>
            AnimateElement(AskToQuit_Control, POPUP_BG, true, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task HideAskToQuit() =>
            AnimateElement(AskToQuit_Control, POPUP_BG, false, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task ShowOnBoardAskPopup() =>
            AnimateElement(OnBoardAsk_Control, POPUP_BG, true, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task HideOnBoardAskPopup() =>
            AnimateElement(OnBoardAsk_Control, POPUP_BG, false, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task ShowLauncherUpdatePopup() =>
            AnimateElement(LauncherUpdate_Control, POPUP_BG, true, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task HideLauncherUpdatePopup() =>
            AnimateElement(LauncherUpdate_Control, POPUP_BG, false, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));

        public static Task ShowInstallLocation()
        {
            InstallLocation_Control.SetupInstallLocation();
            return AnimateElement(InstallLocation_Control, POPUP_BG, true, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));
        }

        public static Task HideInstallLocation() =>
            AnimateElement(InstallLocation_Control, POPUP_BG, false, (bool)IniSettings.Get(IniSettings.Vars.Disable_Animations));
